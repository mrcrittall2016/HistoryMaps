...
<html>
    ...
    <body class = "background">
        ...
        <div class = "supporting-1">
            <div class = "container">
                <div class = "row">                    
                    <div class = "col-xs-12"><div class = "dialogue well_custom well-primary register_login"><h2>Please Log In!<h2>
                        <form action="login.php" method="post">
                            ...
                            <p><a href = "reset.php">Forgotten your password?</a></p>
                            <div class = "form-group">
                                <button type = "submit" class = "btn_block">Submit</button>
                            </div>                            
                        </form>
                        <p><a href = "register.php">Or click here to register!</a></p>
