                ...
                <div class = "row">
                    ...
                    <div class = "col-xs-12">
                        <div class = "dialogue well_custom well-primary register_login">
                            <h2>Please enter your email address to retrieve your account details...</h2>
                            
                            <form action="reset.php" method="post">                     
                                <div class = "form-group">                      
                                    <input autocomplete="off" autofocus class="form-control" id="email" name="email" placeholder="Email Address" type="text"/>
                                </div>            
                                <div class = "form-group">
