...
<html>
    <head>
        ...
        <!--Script to reveal mobile menu -->
        <script src="/js/crittall.js"></script>
        ...
        <script>
            ...
            $(function(){
               ...
               $('.menu li a, .mobile_menu-primary li').click(function(){
    ...
    <body class = "background">
        <div class = "header header-primary">
            <div class = "container-fluid">
                ...
                <div class = "btn_block mobile_menu">                  
                    <i class="fa fa-bars" aria-hidden="true"></i>
                    <i class="fa fa-long-arrow-up" aria-hidden="true"></i>
                </div>
                <!--<div class = "white_block btn_block"></div>-->             
                <div class = "row">
                    <div class = "col-xs-12">
                        <div class = "dialogue dialogue-primary well_custom well-primary shadow_primary">
                            <ul class = "mobile_menu-primary">
                                <li>About</li>
                                <!--<a href = "register_new.html"><li>Sign Up</li></a>-->
        ...
        <div class = "supporting-1">
            <div class = "container">
                <div class = "row">                    
                    <div class = "col-xs-12">
                        <div id = "about" class = "dialogue well_custom well-primary">
                            <div id = "wrap">
                                <h2>Welcome!<h2>
                                <p>History Maps is an educational webapp game that aims to convey in a fun manner some of the major events in military history. What will you choose to learn about?<br> <p>Start your journey by clicking 
                                <a href = "index.php"><span>here</span></a>
                                </p>
                            </div>
                        </div>
                    </div>
