...
function form_check(){
    $('.form-group .btn_block').click(function(){
		...
		var fields_list = {fields:{Location:$('form select[name="location"]').val(), Question:$('form select[name="question"]').val(),Answer:$('form input[name="correct_answer"]').val(), Wrong1:$('form input[name="wrong_answer1"]').val(), Wrong2:$('form input[name="wrong_answer2"]').val(), Wrong3:$('form input[name="wrong_answer3"]').val(), Comments:$('form input[name="explain"]').val()}}
