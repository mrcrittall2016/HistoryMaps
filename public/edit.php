<?php
    ...
    else if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        if ($_POST["optradio"] == "no")
        {
            ...
            $rows = CS50::query("UPDATE `final project`. `{$_POST["location"]}` SET name = ?, choice1 = ?, choice2 = ?, choice3 = ?,
        ...
        else if ($_POST["optradio"] == "yes")
        {
            ...
            $rows = CS50::query("DELETE FROM `final project`. `{$_POST["location"]}` WHERE name = ?", $_POST["question"]);
