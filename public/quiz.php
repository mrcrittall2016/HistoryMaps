<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET")
    {
        ...
        render("question.php", ["title" => $_SESSION["location"], "question" => $question, "answered" => $_SESSION["answered"]]);
    ...
    else if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        if ($_SESSION ["answered"] >= $_SESSION["number_of_questions"])
        {
            ...
            if ($_SESSION["location"] == "Mondego Bay" || $_SESSION["location"] == "Waterloo")
            {
                ...
                CS50::query("UPDATE `history_maps`.`scores` SET British = ?, French = ? WHERE Battle = ? AND username = ?", $_SESSION["British"], $_SESSION["French"], $_SESSION["location"], $username); 
            ...
            CS50::query("INSERT INTO `final project` . `scores`(username, Battle, battle_index, British, French) 
        ...
        if (!isset($_POST["optradio"]) && ($_SESSION["value"] == "correct" || $_SESSION["value"] == "incorrect"))
        {
            ...
            render("question.php", ["title" => $_SESSION["location"], "question" => $_SESSION["question"], "answered" => $_SESSION["answered"]]);
