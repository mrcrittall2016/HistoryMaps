<?php
    ...
    else if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        $return = CS50::query("SELECT email_address FROM `final project`. `users` WHERE email_address = ?", $_SESSION["email"]); 
        ...
        $return = CS50::query("UPDATE `final project`. `users` SET hash = ? WHERE email_address = ?", password_hash($_POST["reset"], 
