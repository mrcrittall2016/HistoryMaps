<?php
    ...
    else if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        else if ($_POST["optradio"] == "yes")
        {
            ...
            $rows = CS50::query("SELECT * FROM `final project` . `users` WHERE institution = ?", $_POST["institution"]); 
            ...
            $result = CS50::query("INSERT IGNORE INTO `final project`. `users` (username, institution, email_address, hash, admin) 
            ...
            $rows = CS50::query("INSERT IGNORE INTO `final project`. `scores` (username, Battle, battle_index, British, French)
        ...
        $result = CS50::query("INSERT IGNORE INTO `final project`. `users` (username, institution, email_address, hash) 
