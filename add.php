<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET")
    {
        ...
        $rows = Database::query("SELECT admin FROM `history_maps`. `users` WHERE id = ?", $_SESSION["id"]);
    ...
    else if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        */ 
        ...
        $rows = Database::query("INSERT INTO `history_maps`. `{$_POST["location"]}` (questionid, name, choice1, choice2, choice3, answer, explanation) 
