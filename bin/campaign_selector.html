    ...
    <body class = "background">
        <div class = "header">
            <div class = "container-fluid">
                ...
                <div class = "row">
                    <div class = "col-xs-12"><div class = "dialogue well_custom well-primary"><h1>Campaign Selector</h1></div></div>
                </div>
                <!--<div class = "btn_block">                  
        ...
        <div class = "selection">
            <div class = "container-fluid">
                <div class = "row">
                    ...
                    <div class = "col-md-4">
                        <div class = "dialogue well_custom well-primary alexander"><h2>Alexander the Great</h2></div>
                        <div class = "dialogue well-primary picture_select alexander"><img src = "Map_images/alexander.jpg"></div>
                    </div>
                    <div class = "col-md-4">
                         <div class = "dialogue well_custom well-primary wellington"><h2>Road to Waterloo</h2></div>
                         <div class = "dialogue well-primary picture_select wellington"><img src = "Map_images/wellington.jpg"></div>
                    </div>
                    <div class = "col-md-4">
                         <div class = "dialogue well_custom well-primary war"><h2>World War II</h2></div>
        ...
        <div class = "supporting-1">
            <div class = "container">
                <div class = "row">                   
                    <div class = "col-xs-12"><div class = "dialogue well_custom well-primary"><h2>Choose your campaign! Which journey through history will you embark on?</h2>
                        
                    <p><a href = "">Or click here to logout</a></p>
