...
<html class="quiz">
    ...
    <head>
        ...
        <!-- Javascript to enable href to be submitted as POST rather than GET. Possibly does not work with new Chrome version -->
    ...
    <body class = "question">
        ...
        <div id ="frame">
            ...
            <font id="title">Sorry, that is incorrect!</font>
