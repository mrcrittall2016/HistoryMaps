        ...
        <div class = "supporting-1">
            <div class = "container">
                <div class = "row">
                    ...
                    <div class = "col-xs-12"><div id = "about" class = "dialogue well_custom well-primary"><h2>Welcome!<h2><p>History Maps is an educational webapp game that aims to convey in a fun manner some of the major events in military history. What will you choose to learn about?<br> <p>Start your journey by clicking <a href = "login.php"><span>here</span></a></p></div></div>
                </div>
            </div>
        </div>        
